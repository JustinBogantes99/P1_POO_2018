...
public class EnviarCorreoAdjunto {
    public static void main(String args[]){
        try{
            ...
            adjunto.setDataHandler(new DataHandler(new FileDataSource("C:\\Users\\manue\\pruebaAdjunto.pdf")));
            adjunto.setFileName("pruebaAdjunto.pdf");
            ...
            message.addRecipient(Message.RecipientType.TO, new InternetAddress("manuelariasmedina@outlook.com"));
